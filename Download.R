...
#Retrieving data from the NCBI database where "db= nuccore" specifies we are looking at the nucleotide database, id references the names of sequences previously specified, and retype lets us specify which format the sequence data will be returned as
